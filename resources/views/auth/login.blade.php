            ...
            <div class="mt-10">
                <form class="space-y-6" action="/login" method="POST">
                    ...
                    @if (session('status') && !$errors->any())
                        <div class="bg-green-100 border border-green-400 px-4 py-3 rounded-md">
                            <p class="block text-sm font-medium leading-6 text-green-700">
                                {{ session('status') }}
                            </p>
                        </div>
                    @endif
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-black px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black transition-colors">Sign
                            in</button>
                    </div>
                </form>
                ...
                <p class="mt-10 text-center text-sm text-gray-500">
                    ...
                    <a href="/register" class="font-semibold leading-6 text-black hover:text-neutral-800">Register</a>
                </p>
            </div>
        </div>
    </div>
