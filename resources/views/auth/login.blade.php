        ...
        <div class="p-6 border rounded-md sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <div class="mt-10">
                <form class="space-y-6" action="/login" method="POST">
                    ...
                    <div>
                        <button type="submit"
                            class="flex w-full justify-center rounded-md bg-black px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-neutral-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black">Sign
                            in</button>
                    </div>
                </form>
